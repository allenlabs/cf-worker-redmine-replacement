// TanStack Start–aware helpers.  Verbatim port of context / focus / inbox
// auth-runtime.server.ts.
//
...
// Request-scoped dedupe: every per-request loader shares one Promise<user|null>
// via this WeakMap.  GC'd when the request exits.
