// HMAC middleware for the concierge API worker.
//
// Every /v1/* request must carry:
//   X-Client-Id   — the concierge.api_clients.client_id (e.g. 'inbox', 'focus', 'pm', 'cli')
...
import { findApiClientImpl } from '../../../web/app/server/concierge';
