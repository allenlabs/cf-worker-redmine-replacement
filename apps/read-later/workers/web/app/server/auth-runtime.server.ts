// TanStack Start–aware helpers.  Verbatim port of focus / inbox / context
// auth-runtime.server.ts — read-later is single-tenant per user too.
//
...
// Request-scoped dedupe (same pattern as PM / inbox / focus / context):
// every per-request loader shares one Promise<user|null> via this WeakMap.
