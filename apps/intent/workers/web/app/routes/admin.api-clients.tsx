    ...
    >
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
        <input
          ...
          className="rounded bg-slate-950 border border-slate-800 px-3 py-2 text-sm font-mono text-slate-100 focus:border-intent-500 focus:outline-none"
        ...
        <input
          ...
          aria-label="Name"
          className="rounded bg-slate-950 border border-slate-800 px-3 py-2 text-sm text-slate-100 focus:border-intent-500 focus:outline-none"
...
export function IssuedSecret({ clientId, hmacSecret, onDismiss }: IssuedSecretProps) {
  return (
    <div className="card border-intent-700 bg-intent-900/30 p-3" data-testid="issued-secret">
      <div className="text-sm font-semibold text-intent-200">
