...
// auth-runtime.server.ts — stash is single-tenant per user too.
//
...
// Request-scoped dedupe (same pattern as PM / inbox / focus / context): every
// per-request loader shares one Promise<user|null> via this WeakMap.  GC'd
