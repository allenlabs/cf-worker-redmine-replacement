// HMAC helpers — verbatim port of inbox/focus/context lib/hmac.ts.  Shared
// between the API worker (verifies inbound) and any tooling we add to sign
// requests (CLI, browser ext).
//
// Scheme:
