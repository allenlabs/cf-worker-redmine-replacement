...
//
// Mirrors the inbox client verbatim (per-request WeakMap cache, retry-wrapped
// proxy on connection-shaped errors).  Pinned search_path = `focus, public`
// so unqualified table refs in schema.ts resolve to our app schema.
//
