...
//
// TanStack Start 1.168 single-call API.  See PM/inbox server.tsx for the
// long rationale on the env-on-globalThis stash + OTel wrapping.
import {
  createStartHandler,
...
const otelConfig: ResolveConfigFn<Env> = (env) => ({
  service: { name: 'focus-web', version: '0.1.0' },
  exporter: {
