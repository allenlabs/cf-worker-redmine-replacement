// TanStack Start–aware helpers.  Verbatim port of inbox's
// auth-runtime.server.ts — focus is single-tenant per user too.
//
...
// Request-scoped dedupe (same pattern as PM / inbox): every per-request
// loader shares one Promise<user|null> via this WeakMap.  GC'd when the
// request exits.
