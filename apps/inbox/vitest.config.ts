  ...
  test: {
    ...
    coverage: {
      ...
      exclude: [
        ...
        // Routes are mostly thin loaders/components covered by wrangler
        // integration tests (PM convention).  The pure impls behind them
        // live in workers/web/app/server/*.ts which DO need coverage.
        ...
        // instrumentation (same shape as PM's server.tsx) — exercised via
      ...
      thresholds: {
        // Match PM's baseline (PM reports drift to ~99.66% on routes).
        // Inbox starts at 100; let it drift the same way under organic
        // route growth without lying about the target.
        lines: 99,
        statements: 99,
        functions: 99,
        branches: 99,
